...
# parser.add_argument("--dqn_embed_checkpoint", type=str, default=None)
...
# parser.add_argument('--only_generate', default=False, help='do not conduct evaluations')
...
parser = argparse.ArgumentParser()
parser.add_argument('--config_name', type=str, default='strat',required=True)
...
parser.add_argument('--only_generate', default=False, help='do not conduct evaluations')
parser.add_argument('--chinese', action='store_true', help='chinese language')
parser.add_argument('--add_nlg_eval', default=False, help='add nlg-eval')
...
parser.add_argument("--infer_batch_size", type=int, default=16)
parser.add_argument('--infer_input_file', type=str, default='./_reformat/test_anno_nocon.txt', nargs='+', required=True)
...
for infer_idx, infer_input_file in enumerate(args.infer_input_file):
    ...
    for batch, posts, references, sample_ids in infer_dataloader:
        ...
        logits = dqn.choose_action2(batch['last_sentence'], batch['attention_mask_ls'], 
