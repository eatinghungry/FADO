...
class BucketSampler(Sampler):
    ...
    def __init__(self, lens, bucket_size, batch_size,
        ...
        self._lens = lens #list of feature len=sentence length+eos+bos+strat
    ...
    def __iter__(self):
        ...
        batches = [ids[i:i+self._batch_size]
...
class BucketingDataLoader(object):
    def __init__(self, toker, feature_dataset, batch_size,
        ...
        with open(f'./DATA/{inputter_name}.{config_name}/data2.pkl', 'rb') as f:
