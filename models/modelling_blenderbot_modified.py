...
class BlenderbotSmallDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        if strat_hidden_states is not None:
            ...
            hidden_states_strat, cross_attn_strat_weights, cross_attn_strat_present_key_value = self.encoder_attn(
                hidden_states=hidden_states,
...
class BlenderbotSmallEncoder(BlenderbotSmallPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        #strat_embeds = self.embed_tokens(kwargs['strat_def']) * self.embed_scale
        ...
        # hidden_strat_states = strat_embeds + embed_pos
